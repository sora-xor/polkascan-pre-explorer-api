...
app.add_route('/asset/{item_id}', polkascan.AssetDetailResource())
app.add_route('/ethereum-bridge/outcome', polkascan.SORAToEthereumBridgeListResource())
app.add_route('/ethereum-bridge/income', polkascan.EthereumToSORABridgeListResource())
app.add_route('/ethereum-bridge/{item_id}', polkascan.EthereumBridgeDetailResource())
